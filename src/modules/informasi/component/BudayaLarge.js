          ...
          <div className={style.h2}>
            ...
            <div className='flex text-lg relative'>
              <List className='list-none text-md mt-3' withPadding>
                <List.Item>1. KEPEMIMPINAN</List.Item>
            ...
            <div className='flex text-lg relative'>
              <List className='list-none text-md mt-3' withPadding>
                <List.Item>2. KERJASAMA DALAM TIM</List.Item>
                <List className='list-none text-md mt-3 font-[350] text-[#4B3F3F]' withPadding>
            ...
            <div className='flex text-lg relative'>
              <List className='list-none text-md mt-3' withPadding>
                <List.Item>3. BERBASIS DATA</List.Item>
                <List className='list-none text-md mt-3 font-[350] text-[#4B3F3F]' withPadding>
            ...
            <div className='flex text-lg relative'>
              <List className='list-none text-md mt-3' withPadding>
                <List.Item>4. KOMUNIKASI</List.Item>
                <List className='list-none text-md mt-3 font-[350] text-[#4B3F3F]' withPadding>
            ...
            <div className='flex text-lg relative'>
              <List className='list-none text-md mt-3' withPadding>
                <List.Item>5. BUDAYA BELAJAR</List.Item>
                <List className='list-none text-md mt-3 font-[350] text-[#4B3F3F]' withPadding>
            ...
            <div className='flex text-lg relative'>
              <List className='list-none text-md mt-3' withPadding>
                <List.Item>6. BUDAYA ADIL</List.Item>
                <List className='list-none text-md mt-3 font-[350] text-[#4B3F3F]' withPadding>
