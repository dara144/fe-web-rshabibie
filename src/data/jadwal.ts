...
export const klinik = {
  penyakitDalamKonsultanGinjalHipertensi: 'Penyakit Dalam Konsultan Ginjal Hipertensi',
...
export const jadwalDokter = [
  ...
  },
  {
    ...
    nama: 'dr. Ining Kartika Tarmidi, Sp.PD,FINASIM',
    image: 'dr. Ining Kartika Tarmidi, Sp.PD,FINASIM.png',
    noIzin: '0017/IPFK-DU/X/2022/DPMPTSP',
    jadwal: [
      {
        hari: `${hari.senin} & ${hari.kamis}`,
        jamMulai: '16.00',
        jamSelesai: '18.00'
      }
    ]
  ...
  {
    klinik: klinik.penyakitDalam,
    nama: 'dr. Muhammad Iqbal, Sp.PD',
    image: 'dr. Muhammad Iqbal, Sp.PD.png',
    noIzin: '0081/IPFK-DS/III/2023/DPMPTSP',
    jadwal: [
      {
